...
import { uploadCoverImage, uploadProfile } from "../middleware/fileUploadMiddleware.js";
...
adminRouter.post("/updateadminprofile", authAdmin, uploadProfile, updateProfile);
